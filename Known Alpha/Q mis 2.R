...
bi.sim.Q.mis = function(seed.l, seed.y, alpha_n1 = 0, alpha_p1 = 0,alpha0_n1 = 0, alpha0_p1 = 0, size){
  tryCatch({
    ...
    #Q(X) parameter is not correctly specified.
    ...
    #multiple robust estimator for E[Y+|PI = 4, X]
    ...
    #we get the predicted values for the IVT method
    ...
    #we get the predicted values for the MR method
    ...
    #correct classification for the IVT method
    ...
    #correct classification for the MR method
