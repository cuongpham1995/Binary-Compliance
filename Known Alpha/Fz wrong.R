...
bi.sim.fz.mis = function(seed.l, seed.y, alpha_n1 = 0, alpha_p1 = 0,alpha0_n1 = 0, alpha0_p1 = 0, size){
  tryCatch({
    ...
    ###### Obtain the predicted treatment assignment when applying #################   
    
    #the proposed method (IPW)
    ...
    #the method proposed by Cui and Tchetgen
    ...
    #correct classification rate for the IPW method
    ...
    #correct classification rate for the OWL method
    ...
    #correct classification rate for the Cui and Tchetgen method
    ...
    #correct classfication rate for the multiply robust method
    ...
    ############### Calculate the value function using the regular non-robust method ###############################
...
bi.sim.fz.mis(83,267,alpha_n1 = -0.5, alpha_p1 = 0.5, size = 2000)
