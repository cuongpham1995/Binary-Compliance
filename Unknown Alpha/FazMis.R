...
#########################################################################################################
###################### Function for fixed alpha_1 ###############################################
#####################################################################################################
#true.al_n1 = 0.5
#true.al_p1 = -0.5

bi.sim.faz.mis = function(seed.l, seed.y, true.al_n1, true.al_p1, alpha_n1 = 0, alpha_p1 = 0,alpha0_n1 = 0, alpha0_p1 = 0, size){
  tryCatch({
    require(locClass)
    require(dplyr)
    require(DynTxRegime)
...
temp.df = mapply(bi.sim.faz.mis, seed.l = seed.l, seed.y = seed.y, 
...
correct <- paste(true.al_p1, true.al_n1, size, "faz mis" ,sep = " ")
