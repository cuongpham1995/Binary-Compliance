...
#########################################################################################################
###################### Function for fixed value alpha ###############################################
#####################################################################################################
#true.al_n1 = 0.5
#true.al_p1 = -0.5

bi.sim.faz.mis = function(seed.l, seed.y, true.al_n1, true.al_p1, alpha_n1 = 0, alpha_p1 = 0,alpha0_n1 = 0.5, alpha0_p1 = 0.5, size){
  tryCatch({
    require(locClass)
    require(dplyr)
    require(DynTxRegime)
