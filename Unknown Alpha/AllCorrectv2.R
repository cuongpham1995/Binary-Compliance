#In this file, we do sensitivity analysis on alpha_1. But We misspecify alpha_0. 
#All the nuisance parameters are correctly specified in this one
...
correct <- paste(true.al_p1, true.al_n1, size, "all correct" ,sep = " ")
